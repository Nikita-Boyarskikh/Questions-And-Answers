# Contributing to Questions-And-Answers

Looking to contribute something to Questions-And-Answers? **Here's how you can help.**
...
The [issue tracker](https://github.com/Nikita-Boyarskikh/Questions-And-Answers/issues) is
...
1. [Fork](https://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/Questions-And-Answers.git
   # Navigate to the newly cloned directory
   cd Questions-And-Answers
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/Nikita-Boyarskikh/Questions-And-Answers.git
   ```
...
Check your code style by running pylint <your_package>.
